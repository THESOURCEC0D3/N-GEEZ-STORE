...
const Testimonials = () => {
  ...
  return (
    <section className="py-20 overflow-hidden" style={{ backgroundColor: config.theme.accentLight }}>
      <motion.div
      ...
      >
        ...
        <div className="relative flex overflow-hidden cursor-pointer">
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 w-15" style={{ background: `linear-gradient(to right, ${config.theme.accentLight}, transparent)` }}></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 w-15" style={{ background: `linear-gradient(to left, ${config.theme.accentLight}, transparent)` }}></div>
        </div>
      </motion.div>
    </section>
  );
